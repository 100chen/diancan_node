...
class regcheck extends checking{
	start(){
		...
		super.Password('密码必须是6到20位的数字和字母组合',1)
	}
}
...
class putoncheck extends checking{
	start(){
		let arr = ['请选择菜品类目','请输入菜品名称','请输入菜品价格','请选择菜品单位','请上传菜品图片']
		super.Errunder()
		super.Parameter(arr)
		super.Blank(arr)
...
module.exports = {regcheck,shopinfor,checking,catecheck,unitcheck,putoncheck,postcode}